package org.flyte.display{
	...
	public class ActionManager extends EventDispatcher {
		...
		/**
		 * Forces the ActionManager to set the active property of the current action to false.
		 * @param action The Action to set
		 */
		 public function forceActionOff(action:String):void
		 {
			 a[action].active=false;
		 }
		/**
